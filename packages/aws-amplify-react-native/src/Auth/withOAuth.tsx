...
import { Logger, Hub } from '@exodus/aws-amplify_core';
import { Auth, CognitoHostedUIIdentityProvider } from '@exodus/aws-amplify_auth';
	...
	return class WithOAuth extends React.Component<Props & IWithOAuthProps, IWithOAuthState> {
		...
		_getOAuthConfig() {
			if (!Auth || typeof Auth.configure !== 'function') {
				throw new Error('No Auth module found, please ensure @exodus/aws-amplify_auth is imported');
			}
